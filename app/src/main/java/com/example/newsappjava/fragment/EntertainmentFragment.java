...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enterRV = v.findViewById(R.id.entertainmentRecyclerView);
        modelNewsArrayList = new ArrayList<>();
        enterRV.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new NewsAdapter(getContext(), modelNewsArrayList);
        enterRV.setAdapter(adapter);
